...
import { removeMemberBirthday } from '@/app/dashboard/[guildId]/(management)/birthdays/actions'
...
function BirthdayCalendar({ birthdays, guildTz }: { birthdays: MemberBirthday[]; guildTz: string }) {
