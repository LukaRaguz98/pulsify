  ...
  'alt-detection': {
    ...
    body: (
      <>
        ...
        <p><strong>Heads up:</strong> Risk checks and <code>/alt check</code> are free; join-time auto-flagging at scale is a paid tier. Discord exposes no IP or device data, so nothing here proves an alt — a high score is evidence to review, and linked accounts are <em>potential</em> matches; the judgement stays yours.</p>
      </>
    ),
  },
  'ai-setup': {
