...
const ACTION_CATALOG: ActionDef[] = [
  ...
  { id: 'act-invite-leaderboard', label: 'View invite leaderboard', subtitle: 'Top inviters by score', icon: 'Trophy', keywords: 'invite invites leaderboard top inviters ranking referral score valid', action: { kind: 'navigate', href: '/leaderboard?board=invites' } },
  { id: 'act-open-leaderboard', label: 'Open leaderboards', subtitle: 'Every ranking: level, reputation, activity, coins, invites, gaming', icon: 'Trophy', keywords: 'leaderboard leaderboards ranking levels xp top members rank progression board', action: { kind: 'navigate', href: '/leaderboard' } },
  { id: 'act-richest-leaderboard', label: 'View richest leaderboard', subtitle: 'Top Pulse Coin balances', icon: 'Coins', keywords: 'richest wealth coins balance economy leaderboard ranking top wallets', action: { kind: 'navigate', href: '/leaderboard?board=richest' } },
  { id: 'act-gaming-leaderboard', label: 'View gaming leaderboard', subtitle: 'Top players by playtime & sessions', icon: 'Gamepad2', keywords: 'gaming games playtime sessions players leaderboard ranking top most played', action: { kind: 'navigate', href: '/leaderboard?board=gaming' } },
