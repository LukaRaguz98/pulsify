...
export const TYPE_LABELS: Record<NotificationType, string> = {
  ...
  temp_role_assigned: 'Temporary role assigned',
  temp_role_expiring: 'Temporary role expiring',
  temp_role_expired: 'Temporary role expired',
  temp_role_extended: 'Temporary role extended',
...
export const TYPE_DESCRIPTIONS: Record<NotificationType, string> = {
  ...
  temp_role_assigned: 'A member is granted a time-limited role.',
  temp_role_expiring: 'A temporary role is about to expire.',
  temp_role_expired: 'A temporary role expired and was removed.',
  temp_role_extended: 'A temporary role’s expiration is extended.',
