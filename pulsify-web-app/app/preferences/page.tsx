...
// surface of the app (server dashboards, workspaces, public pages). Lives at
// `/preferences` so it isn't tied to a specific guild — the choose-server view
// + the workspace chooser both expose it from their top-right corner.
//
// Notification preferences for a guild still live at
// /dashboard/[guildId]/notification-settings (per-guild), and feature settings
// live next to their feature.
...
export default function PreferencesPage() {
  ...
  // Reset can undo a session of tweaks and Save can clear the dirty indicator.
  type AppPrefs = {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      {/* Matches the choose-server view chrome so the page reads as a sibling,
